...
![](house_price_prediction_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](house_price_prediction_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
**LotFrontage:** As per the data dictionary, it is the linear feet of
